...
export default function StoresPage() {
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#f1f5f9", fontFamily: "'Inter', system-ui, sans-serif" }}>
      <style>{`* { box-sizing: border-box; } .row:hover { background: #f8fafc !important; } .card:hover { transform: translateY(-1px); box-shadow: 0 4px 20px rgba(0,0,0,0.08) !important; }`}</style>
