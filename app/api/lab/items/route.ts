...
export async function GET(req: NextRequest) {
  ...
  const r = await pool.query(
    `SELECT
      i.id, i.name, i.generic_name AS "genericName", i.itemcode, i.itemtype AS "itemType",
      i.uom, i.manufacturer, i.reorder_level AS "reorderLevel", i.min_level AS "minLevel",
      i.max_level AS "maxLevel", i.controlled, i.critical_reagent, i.analyzer_compat,
